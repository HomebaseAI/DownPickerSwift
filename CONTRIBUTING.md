...
The DownPicker maintainers takes security seriously.
If you discover a security issue, please bring it to our attention right away!

Please **DO NOT** file a public issue,
instead send your report privately to <daniel.chick@homebase.ai>.
...
See [CODE_OF_CONDUCT.md](https://github.com/chickdan/DownPicker/blob/master/CODE_OF_CONDUCT.md) for details.
